...
public class SearchPages {
    ...
    public void typeOnSearchField(String value) { getSearchFieldWebElement().sendKeys(value); }
    public void clickOnSearchButton() { getSearchSubmitButtonWebElement().click(); }
}
