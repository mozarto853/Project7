...
public class LandingPage {
    ...
    public static WebElement getSignUpWebElement() { return signUpWebElement; }

    public static WebElement getSearchWebElement() { return searchWebElement; }

    public void clickOnSignUp(){ getSignUpWebElement().click(); }
    public void clickOnSearch(){ getSearchWebElement().click(); }
